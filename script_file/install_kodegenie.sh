...
# ---------- CONFIG ----------
REPO_MAIN_URL="https://raw.githubusercontent.com/HemantGuptaShorthillsAI/KodeGenie/main/MCP-Serevrs/main.py"
VSIX_URL="https://github.com/HemantGuptaShorthillsAI/KodeGenie/raw/main/Extension-KodeGenie/KodeGenie-3.18.4.vsix"
MAIN_FILE="main.py"
VSIX_FILE="KodeGenie-3.18.4.vsix"
...
echo "⬇️ Downloading KodeGenie VSIX extension..."
...
echo "💻 Installing KodeGenie extension in VS Code..."
code --install-extension "$VSIX_FILE" --force
if [ $? -eq 0 ]; then
    echo "✅ KodeGenie extension installed."
else
